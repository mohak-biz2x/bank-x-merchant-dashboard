...
export function PrivacyPage() {
  return (
    <LegalPage title="Privacy Policy">
      <p>Bank X is committed to protecting your privacy. We collect and process your business information solely for the purpose of evaluating your supply chain financing application.</p>
      ...
      <p>For any privacy-related inquiries, please contact our Data Protection Officer at privacy@bankx.ae.</p>
    </LegalPage>
  );
}
...
export function DisclaimerPage() {
  return (
    <LegalPage title="Disclaimer">
      ...
      <p>Bank X reserves the right to modify terms, conditions, and product offerings at any time without prior notice. Past performance or approval does not guarantee future results.</p>
...
export function TncPage() {
  return (
    <LegalPage title="Terms & Conditions">
      <p>By using the Bank X Supply Chain Finance platform, you agree to be bound by these Terms and Conditions. These terms govern your access to and use of the platform and all related services.</p>
      ...
      <p>All financing arrangements are subject to Bank X's credit policies and approval processes. Approved credit limits, rates, and terms may vary based on the assessment of your business profile.</p>
      <p>Bank X may update these Terms and Conditions from time to time. Continued use of the platform constitutes acceptance of any modifications.</p>
    </LegalPage>
  );
}
