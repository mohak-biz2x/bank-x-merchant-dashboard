...
interface InvoiceForApproval {
  ...
  status: "pending_seller_approval" | "approved" | "rejected";
  approvedDate?: string;
  rejectedDate?: string;
  rejectionReason?: string;
}

export function SellerApprovalsModule() {
  ...
  // Mock data - Invoices pending seller approval
  const [pendingInvoices, setPendingInvoices] = useState<InvoiceForApproval[]>([
    {
      id: "INV-2024-0158",
      buyerId: "BUY001",
      buyerName: "Al Khalij Construction LLC",
      invoiceNumbers: ["AMS-INV-2024-045", "AMS-INV-2024-046"],
      totalAmount: 125000,
    ...
    },
    {
      id: "INV-2024-0159",
      buyerId: "BUY002",
      buyerName: "Emirates Building Materials",
      invoiceNumbers: ["AMS-INV-2024-047"],
      totalAmount: 68500,
    ...
    },
    {
      id: "INV-2024-0160",
      buyerId: "BUY003",
      buyerName: "Sharjah Development Projects",
      invoiceNumbers: ["AMS-INV-2024-048"],
      totalAmount: 92300,
      bankFeeCoveredBy: "buyer",
  ...
  const [historicalInvoices] = useState<InvoiceForApproval[]>([
    {
      ...
      buyerId: "BUY001",
      buyerName: "Al Khalij Construction LLC",
      invoiceNumbers: ["AMS-INV-2024-042", "AMS-INV-2024-043"],
      totalAmount: 145000,
      bankFeeCoveredBy: "buyer",
    ...
    },
    {
      id: "INV-2024-0154",
      buyerId: "BUY004",
      buyerName: "Abu Dhabi Infrastructure LLC",
      invoiceNumbers: ["AMS-INV-2024-041"],
      totalAmount: 78900,
      bankFeeCoveredBy: "seller",
    ...
    },
    {
      ...
      buyerId: "BUY002",
      buyerName: "Emirates Building Materials",
      invoiceNumbers: ["AMS-INV-2024-039"],
      totalAmount: 54200,
      bankFeeCoveredBy: "buyer",
      submittedDate: "2024-03-07",
      rejectedDate: "2024-03-08",
      rejectionReason: "Invoice does not match our delivery records. Please verify quantities and resubmit.",
      invoiceFiles: 1,
      supportingDocs: 1,
      status: "rejected",
    },
    {
      id: "INV-2024-0150",
      buyerId: "BUY005",
      buyerName: "Fujairah Construction Group",
      invoiceNumbers: ["AMS-INV-2024-037"],
      totalAmount: 103500,
      bankFeeCoveredBy: "seller",
    ...
    },
    {
      ...
      buyerId: "BUY003",
      buyerName: "Sharjah Development Projects",
      invoiceNumbers: ["AMS-INV-2024-035", "AMS-INV-2024-036"],
      totalAmount: 87600,
      bankFeeCoveredBy: "buyer",
      submittedDate: "2024-03-01",
      rejectedDate: "2024-03-02",
      rejectionReason: "Payment terms on invoice do not match our agreement. Please correct and resubmit.",
      invoiceFiles: 2,
      supportingDocs: 2,
      status: "rejected",
    },
    ...
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600">
          Review and approve invoices submitted by your buyers for financing
        </p>
      </div>
                    ...
                    <tr key={invoice.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                          ...
                          {invoice.bankFeeCoveredBy === "buyer" ? "Paid by Buyer" : "Paid by You"}
                        </span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
        ...
        <div className="fixed inset-0 bg-[#CBD2DD]/[.72] flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4 bg-gray-50 rounded-lg p-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-gray-900 mt-1">{selectedInvoice.buyerName}</p>
                    <p className="text-xs text-gray-500 mt-0.5">{selectedInvoice.buyerId}</p>
                  </div>
                  <div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        ...
                        <span className="font-semibold">
                          {selectedInvoice.bankFeeCoveredBy === "buyer" ? "the buyer" : "you (seller)"}
                        </span>
                        .
                      </p>
                    </div>
              ...
              {/* Action Buttons */}
              {selectedInvoice.status === "pending_seller_approval" && (
