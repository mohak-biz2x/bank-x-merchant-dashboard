...
export function SellerDashboard() {
  ...
  const approvedLimit = 5000000; // AED 5,000,000
  const utilisedAmount = 3250000; // AED 3,250,000
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl p-6 text-white mb-6 shadow-lg">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-blue-100 text-sm font-medium">Approved Credit Limit</p>
              </div>
              <h2 className="text-4xl font-bold mb-1">{formatCurrency(approvedLimit)}</h2>
              <p className="text-blue-100 text-sm">United Arab Emirates Dirham</p>
            </div>
          ...
          <div className="mt-6">
            <div className="flex justify-between text-sm mb-2">
              <span className="text-blue-100">Credit Utilisation</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Buyers Module */}
          <Link to="/buyers" className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden hover:shadow-md transition-shadow cursor-pointer">
            <div className="p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Manage buyer relationships</p>
                </div>
              </div>
          ...
          {/* Invoices Module */}
          <Link to="/invoices" className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden hover:shadow-md transition-shadow cursor-pointer">
            <div className="p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Track invoice financing</p>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex items-center justify-between py-2 border-b border-gray-100">
